  ...
  try {
    ...
    return {
      ...
      output: {
        ...
        fact_check_summary: "Fact-check could not be completed due to an agent error. The reliability of the research findings has not been independently verified. Readers should apply their own judgment when evaluating the claims in this report.",
        warnings: ["**[Methodology — Fact-Check Unavailable]**: The fact-check agent encountered an error and could not verify any claims. All findings should be treated as unverified."],
      },
      model_used: "none",
      provider: "none",
      durationMs: Date.now() - start,
