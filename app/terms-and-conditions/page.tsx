          ...
          <section className="space-y-5">
            ...
            <div className="space-y-4 mt-6">
              <div className="flex gap-4 p-5 rounded-xl border border-border bg-accent/5 hover:bg-accent/10 transition-colors">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-amber-500/10 text-amber-500 font-bold border border-amber-500/20 text-xl">A</div>
                <div>
              ...
              <div className="flex gap-4 p-5 rounded-xl border border-border bg-accent/5 hover:bg-accent/10 transition-colors">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-blue-500/10 text-blue-500 font-bold border border-blue-500/20 text-xl">B</div>
                <div>
              ...
              <div className="flex gap-4 p-5 rounded-xl border border-border bg-accent/5 hover:bg-accent/10 transition-colors">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-500 font-bold border border-emerald-500/20 text-xl">C</div>
                <div>
